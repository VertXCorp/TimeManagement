...
import VertXTimeManagement.API.TimeManagementAPI;
import VertXTimeManagement.Commands.TotalTimeCommand;
import VertXTimeManagement.Listeners.AFKStatusChangeListener;
import VertXTimeManagement.Listeners.LogInOutListener;
import VertXTimeManagement.Storage.ChangeHandler;
import VertXTimeManagement.Storage.LoginData;
import VertXTimeManagement.Storage.PublicDataContainer;
import VertXTimeManagement.Storage.SQLPool;
...
public class Main extends JavaPlugin implements TimeManagementAPI {
    ...
    public static void disable() {
        Main.sendError("Ran into an error that will break plugin. Disabling...");
